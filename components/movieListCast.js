...
export default function MovieListCast({title,data,hideSeeAll}){
                    ...
                    return (
                        <TouchableWithoutFeedback key={index} onPress={()=>handleClick(item)}>     
                            <View className='space-y-1 mr-4' >
                                <Image source={{uri: img185(item.profile_path) }} style= {{width:width*0.33 , height: height*0.22}} className= 'rounde-3xl'/>
